...
I am a Postdoctoral Scholar in the Department of Psychology at Tufts University, affiliated with the [NeuroCognition of Language Lab](https://kuperberglab.com/). My research interests lie at the intersection of language, cognition, and computation, with a focus on how language is generated and processed by humans and artificial systems. Much of my work leverages theories and insights from cognitive science and psycholinguistics, computational modeling, natural language processing, and behavioral experimentation in service of these questions. 

I received my PhD in [Language Science](https://www.langsci.uci.edu/) from the University of California - Irvine, where I was advised by [Dr. Richard Futrell](https://sites.socsci.uci.edu/~rfutrell/) and affiliated with the [Language Processing Group](https://langprocgroup.github.io/) and the [meaning lab](https://sites.socsci.uci.edu/~gscontra//meaning/). Before that, I earned my Bachelor’s degree in Cognitive Science with a minor in Math from the University of California - San Diego. I also spent a year in industry, working on developing signal processing algorithms for optical sensing across a range of research applications.

## Research
### Publications

<p><strong>Upadhye S.</strong> &amp; Futrell R. Back to the Future: The Role of Past and Future Context Predictability in Incremental Language Production. <em> Open Mind. </em> (in press). </p>
